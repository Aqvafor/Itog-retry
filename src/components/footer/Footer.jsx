    ...
    <footer className="site-footer">
      <div className="content-container column">
          ...
          <div className="footer-content-main">
            <div className="footer-section">
              ...
              <ul className="footer-menu">
                ...
                <li>
                  <a href="/selection">Выбор Ed Space</a>
                </li>
              </ul>
            </div>
            <div className="footer-section">
            ...
            <div className="footer-section">
              ...
              <ul className="footer-menu">
                <li>
                  <a href="/features">admin@site.com</a>
                </li>
                <li>
                  <a href="/pricing">+7 (900) 123-45-67</a>
                </li>
                <li>
                  <a href="/selection">+7 (999) 876-54-32</a>
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="footer-socials">
          <p className="footer-socials-text">
